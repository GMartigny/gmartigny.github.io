...
Dot.prototype.render = function(ctx) {
    ...
    if (this.isGoingOutOfBound("x")) {
        this.vit.x *= -1;
    }
    if (this.isGoingOutOfBound("y")) {
        this.vit.y *= -1;
    }
};
Dot.prototype.isGoingOutOfBound = function(axis) {
    return this.pos[axis] < this.origin[axis] && this.vit[axis] < 0 ||
        this.pos[axis] > this.origin[axis] + this.bound[axis] * Dot.freedom && this.vit[axis] > 0
};
