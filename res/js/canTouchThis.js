    ...
    Touch.handleEvent(ev, function(t){
        ...
        touch.timer = setTimeout(function(){
            ...
            if(touch && !touch.moved){
                ...
                var cev = new CustomEvent("holdtap", {
                    bubbles: true,
                    cancelable: true,
                    detail: touch
                });
        ...
        if(touch){
            ...
            if(touch.moved){
                if(touch.sibling){
                    ...
                    var cev = new CustomEvent("pinch", {
                        cancelable: true,
                        detail: touch
                    });
                    touch.target.dispatchEvent(cev);
                }
                var cev = new CustomEvent("drag", {
                    bubbles: true,
                    cancelable: true,
                    detail: touch
                });
